...
//   const phoneNumberId = process.env.WHATSAPP_PHONE_NUMBER_ID || '671909416004124'; // Replace with actual ID
...
//     //   // Check if this is a reply to the list
//     //   const isListReply = message.interactive && message.interactive.type === "list_reply";

//     //   if (!isListReply) {
//     //     // User just arrived at this node — send the list
//     //     try {
//     //       await sendWhatsAppList(from, question, targetValues);
//     //       return res.status(200).send("✅ List sent");
//     //     } catch (err) {
//     //       console.error("❌ Error in sendWhatsAppList:", err.message);
//     //       return res.status(500).send("Failed to send list message");
//     //     }
//     //   }

//     //   // Handle user's reply to list
...
//     //   console.log("User selected list option:", selectedTitle, "→ index:", selectedIndex);
...
//     //       await sendWhatsAppText(
//     //         from,
//     //         "⚠️ This option is not connected to the next step."
//     //       );
//     //       return res.sendStatus(200);
//     //     }
//     //   } else {
//     //     await sendWhatsAppText(
//     //       from,
//     //       `❌ Invalid option. Reply with one of: ${targetValues.join(", ")}`
//     //     );
//     //     return res.sendStatus(200);
//     //   }
//     // }
...
//         console.log("User selected:", selectedTitle, "→ index:", selectedIndex);
...
//             return res.sendStatus(200);
//           } else {
//             await sendWhatsAppText(from, "⚠️ Option not connected to next step.");
//             return res.sendStatus(200);
//           }
//         } else {
//           await sendWhatsAppText(from, `❌ Invalid option. Please select from the list.`);
//           return res.sendStatus(200);
//         }
//       } else {
//         // Only send list if it's a new node
//         await sendWhatsAppList(from, question, targetValues);
//         return res.status(200).send("✅ List sent");
//       }
//     }
