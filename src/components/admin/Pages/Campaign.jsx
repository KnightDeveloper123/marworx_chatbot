                    ...
                    <Box width="100%" maxW="500px" mx="auto" textAlign="left">
                      ...
                      <Box display={'flex'} flexDirection={'column'}>
                        <FormControl mt={7} isRequired>
                          ...
                          <Select fontSize="var(--text-12px)" >
                            <option value='option1'>Utility</option>
                        ...
                        <FormControl mt={5} isRequired>
                          ...
                          <Input placeholder="Type the name of your template" fontSize="var(--text-12px)" />
                        </FormControl>
                        <FormControl mt={5} isRequired>
                        ...
                        <FormControl mt={5} isRequired>
                          ...
                          <Select placeholder="Choose a language" fontSize="var(--text-12px)" >
                  ...
                  <Box width="100%" mx="auto">
                    <Flex w={"100%"} justifyContent="space-between" alignItems="center" mb="1" >
                      ...
                      <Flex>
                        ...
                        <Button color={"#805ad5"} variant='ghost'>Discard</Button>
                        <Button bgColor={"#805ad5"} color={"white"} _hover={{ bgColor: "gray.500" }} variant='solid'> Save</Button>
                      </Flex>
                    </Flex>
                    ...
                    <Flex w={"100%"}>
                      <Flex flexDirection={"column"} w={"30%"}>
                        ...
                        <Flex alignItems={"center"} mt={5} mb={5} flexDirection={"column"}>
                          ...
                          <Textarea mt={5} placeholder='Enter body text here'></Textarea>
                        </Flex>
                        <Divider borderColor={"black"} />
                        <Flex justifyContent={"space-between"} alignItems={"center"} mt={5} mb={5}>
