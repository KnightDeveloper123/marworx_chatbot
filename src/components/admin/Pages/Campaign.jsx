...
const Campaign = () => {
  ...
  return (
    <Box p={6}>
      ...
      {/* <Modal isOpen={isOpen} onClose={onClose} size="5xl">
        <ModalOverlay />
        <ModalContent p="6" borderRadius="10px">
          <ModalCloseButton />
          <ModalBody>
            <Box width="100%" maxW="500px" mx="auto" textAlign="left">
              <Box fontSize="24px" fontWeight="bold" mb="3">
              ...
              <Box textAlign="left" fontWeight="semibold" mb="2" fontSize="14px">
                How will you name your campaign? <span style={{ fontWeight: "normal" }}>(only you can see it)</span>
              </Box>
              ...
              <Flex justifyContent="flex-end" gap="4">
                <Button variant="ghost" color="purple.500" fontWeight="bold">
                  Discard
                </Button>
                <Button
                  bg="gray.400"
  ...
  <ModalContent p="6" borderRadius="10px">
    ...
    <ModalBody>
      ...
      <Flex justifyContent="space-between" alignItems="center" mb="6" width={'500px'} mx={'auto'}>
        <Flex alignItems="center" gap="2">
          <IconButton
            icon={<ArrowBackIcon />}
            variant="ghost"
      ...
      <Box border="1px solid #E2E8F0" borderRadius="10px" overflow="hidden" width={'500px'} mx={'auto'}>
        ...
        <Flex p="4" alignItems="center" justifyContent="space-between">
          ...
          <Button colorScheme="gray" size="sm" borderRadius="full">
            Start Creating
          </Button>
        </Flex>
      </Box>
